...
void visualizarTarefas(struct Tarefa tarefas[], int totalTarefas) {
    if (totalTarefas == 0) {
        printf("\033[1;33mNenhuma tarefa cadastrada.\033[0m\n");
        return;
    }

    printf("\033[1;34m--- Lista de Tarefas ---\033[0m\n\n");
...
void visualizarComFiltro(struct Tarefa tarefas[], int totalTarefas, int mostrarSomenteConcluidas) {
    ...
    if (!encontrou) {
        printf("\033[1;33mNenhuma tarefa encontrada com esse filtro.\033[0m\n");
    }
}
...
int main() {
    ...
    do {
        printf("\033[1;36mTaskMan - Sistema de Controle de Tarefas\033[0m\n\n");
        printf("Bem-vindo(a) ao TaskMan o melhor sistema de controle de tarefas da atualidade.\n\n");

        printf("Digite \033[1;32m(1)\033[0m para adicionar uma tarefa\n");
        printf("Digite \033[1;33m(2)\033[0m para editar uma tarefa\n");
        printf("Digite \033[1;34m(3)\033[0m para visualizar as tarefas\n");
        printf("Digite \033[1;36m(4)\033[0m para visualizar apenas as tarefas concluidas\n");
        printf("Digite \033[1;31m(5)\033[0m para excluir uma tarefa\n");
        printf("Digite \033[1;35m(6)\033[0m para marcar tarefa como concluida\n\n");
        printf("Digite \033[1;37m(0)\033[0m para sair\n");
